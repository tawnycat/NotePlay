 ...
 var score = 0;
      ...
      for(var i = 0; i < state.notes.length;i++){
        ...
        if(state.notes[i] === state.notesPlayed[i]){
            ...
            notes[i].setKeyStyle(0,{fillStyle: "blue"})
            score++
        }
...
CANVAS);
    ...
    var topStaff = new Vex.Flow.Stave(20, 0, 750);
    var bottomStaff = new Vex.Flow.Stave(20, 60, 750);
    ...
    new Vex.Flow.StaveNote({clef: "treble", keys: ["c/3"], duration: "q" }),
    new Vex.Flow.StaveNote({clef: "treble", keys: ["c/4"], duration: "q" }),
    new Vex.Flow.StaveNote({clef: "treble", keys: ["f/4"], duration: "q" }),
    new Vex.Flow.StaveNote({clef: "treble", keys: ["g/4"], duration: "q" }),
    new Vex.Flow.StaveNote({clef: "treble", keys: ["a/4"], duration: "q" }),
